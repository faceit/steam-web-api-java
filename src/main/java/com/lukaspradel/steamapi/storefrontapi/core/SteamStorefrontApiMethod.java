...
public enum SteamStorefrontApiMethod {
	...
	FEATURED("featured", Featured.class), FEATURED_CATEGORIES(
			"featuredcategories", Object.class), APP_DETAILS("appdetails",
			Appdetails.class), APP_USER_DETAILS("appuserdetails", Object.class), MESSAGES(
			"messages", Object.class), PACKAGE_DETAILS("packagedetails",
			Object.class), SALE_PAGE("salepage", Object.class);
